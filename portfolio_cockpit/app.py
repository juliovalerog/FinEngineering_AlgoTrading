...
with tabs[1]:
    ...
    col_c.metric("Benchmark source", "SPY / S&P 500 ETF proxy")
    ...
    st.caption("The Excel benchmark series is SPY-like in scale; therefore Yahoo refresh uses SPY to preserve benchmark continuity.")
